...
s0_switch_strictly_between_applications = true
...
s0_left_maximize = <Alt>Left
s0_right_maximize = <Alt>Right
...
[core]
s0_active_plugins = core;composite;opengl;copytex;grid;mousepoll;wall;snap;regex;animation;compiztoolbox;vpswitch;resize;commands;move;imgpng;place;fade;workarounds;session;unitymtgrabhandles;scale;expo;ezoom;unityshell;
...
s0_unmaximize_or_minimize_window_key = <Alt>Down
...
s0_toggle_window_maximized_horizontally_key = <Shift><Alt>Right
s0_toggle_window_maximized_vertically_key = <Shift><Alt>Up
